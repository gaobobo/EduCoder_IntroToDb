...
case $DownloadSite in
    Gitee)
        curl -o /tmp/MySQL1-5/MySQL1-5.sql https://gitee.com/coconut_floss/EduCoder_IntroToDb/raw/main/sql/MySQL1-5/MySQL1-5.sql
        ;;
    Github)
        curl -o /tmp/MySQL1-5/MySQL1-5.sql https://raw.githubusercontent.com/gaobobo/EduCoder_IntroToDb/main/sql/MySQL1-5/MySQL1-5.sql
        ;;
    *)
